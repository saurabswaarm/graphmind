...
from ..schemas.relationship import RelationshipCreate, RelationshipUpdate, RelationshipRead
...
async def create_relationship(
    ...
    upsert: bool = Query(False, description="If true, update the relationship instead of failing on conflict"),
...
async def update_relationship(
    ...
    if relationship_update.metadata is not None:
        if metadata_mode == "merge":
            ...
            relationship.metadata = {**relationship.metadata, **relationship_update.metadata}
        else:
